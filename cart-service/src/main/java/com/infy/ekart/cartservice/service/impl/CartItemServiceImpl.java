...
public class CartItemServiceImpl implements CartItemService {
    ...
    public CartItemResponse addItem(String cartId, AddItemRequest request) {
        ...
        // ✅ DISABLED STOCK CHECK FOR TESTING
        ...
        if (existingItem != null) {
            ...
            // ✅ Use default price if pricing service fails
            BigDecimal price = BigDecimal.valueOf(999);
            try {
                price = pricingClient.getProductPrice(request.skuId());
            } catch (Exception e) {
                log.warn("Pricing service failed, using default price 999");
            }
