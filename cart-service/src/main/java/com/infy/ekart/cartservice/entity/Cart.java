...
public class Cart {
    ...
    // ✅ Changed from List to Set
    @OneToMany(mappedBy = "cart", cascade = CascadeType.ALL, orphanRemoval = true, fetch = FetchType.LAZY)
    private Set<CartPromotion> promotions = new HashSet<>();
    ...
    public Set<CartPromotion> getPromotions() { return promotions; }
    public void setPromotions(Set<CartPromotion> promotions) { this.promotions = promotions; }
